...
set REFSET_ORGANIZATION_ICON_URL_PREFIX=organization/icon/
set REFSET_ORGANIZATION_ICON_AWS_DIR=icon/organization/
set REFSET_USER_ICON_FILE_DIR=icon/user/
set REFSET_USER_ICON_URL_PREFIX=user/icon/
...
* http://localhost:8080/refsetservice/admin/migration/rtt
