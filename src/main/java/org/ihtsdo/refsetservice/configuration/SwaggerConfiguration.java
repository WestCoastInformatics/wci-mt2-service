...
public class SwaggerConfiguration {
    ...
    private ApiInfo apiInfo() throws IOException {
        ...
        return new ApiInfoBuilder().title("IHTSDO Refset Service")
            .description("Documentation for the API endpoints used to support the SNOMED CT Reference Set Tool 2.0.\n" + "\n" + "<b>Authentication Note</b>\n"
                + "The application supports guest access, so many of the GET endpoints here work properly " + "without requiring authentication.\n" + "\n"
                + "PUT/POST endpoints that make changes will require being signed in before they will " + "function properly.\n" + "\n"
                ...
                + "username. This call will check your verify your IMS cookie and create an application " + "session for that cookie.\n" + "\n"
            ...
            .termsOfServiceUrl("https://confluence.ihtsdotools.org/display/SCTCR/Content+Request+Service+Terms+of+Service").version("0.0.1")
