...
public class SnowstormRefsetMember extends SnowstormAbstract {
        ...
        try {
            ...
            if (searchParameters.getQuery() != null && !searchParameters.getQuery().isEmpty()) {
                ...
                final String url = SnowstormConnection.getRestBaseUrl() + RefsetMemberService.getBranchPath(refset) + "/members?referenceSet=" + refsetId
                    ...
                    + SnowstormApiPaging.getMemberSortQueryString();
    ...
    public static void populateMembershipInformation(final Refset refset, final List<Concept> concepts) throws Exception {
        ...
        final String baseUrl = SnowstormConnection.getRestBaseUrl() + RefsetMemberService.getBranchPath(refset) + "/members?referenceSet=" + refset.getRefsetId()
            + "&active=true&limit=" + RefsetMemberService.ELASTICSEARCH_MAX_RECORD_LENGTH + "&offset=0&"
            + SnowstormApiPaging.getMemberSortQueryString() + "&referencedComponentId=";
        final List<Concept> conceptsToProcess = new ArrayList<>();
        String conceptIds = "";
        int snowstormCallCount = 0;
                ...
                executor.submit(new Runnable() {
                    ...
                    public void run() {
                        ...
                        try {
                            ...
                            final ConceptLookupParameters lookupParameters = new ConceptLookupParameters();
                            lookupParameters.setGetMembershipInformation(true);
                            final ResultListConcept resultList = SnowstormConcept.getConceptsFromSnowstorm(memberUrl, refset, lookupParameters, null);
    ...
    public static List<Map<String, String>> getMemberHistory(final TerminologyService service, final String referencedComponentId,
        ...
        for (final Map<String, String> version : versions) {
            ...
            final String url = SnowstormConnection.getRestBaseUrl() + RefsetService.getBranchPath(refset) + "/members?referenceSet=" + refset.getRefsetId()
                + "&referencedComponentId=" + referencedComponentId + "&" + SnowstormApiPaging.getMemberSortQueryString();
    ...
    public static boolean cacheMemberAncestors(final Refset refset) throws Exception {
        ...
        final String memberCountUrl = SnowstormConnection.getRestBaseUrl() + RefsetMemberService.getBranchPath(refset) + "/members?referenceSet="
            + refset.getRefsetId() + "&active=true&limit=1&" + SnowstormApiPaging.getMemberSortQueryString();
    ...
    public static List<String> addRefsetMembers(final TerminologyService service, final User user, final Refset refset, final List<String> conceptIds)
        ...
        final String memberSearchUrl = SnowstormConnection.getRestBaseUrl() + branchPath + "/members/search?"
            + SnowstormApiPaging.getMemberSearchPagingQueryString(
                new SearchParameters(null, RefsetMemberService.ELASTICSEARCH_MAX_RECORD_LENGTH, null));
                ...
                try (final Response response = SnowstormConnection.postResponse(memberSearchUrl, memberSearchBody)) {
                    ...
                    while (iterator != null && iterator.hasNext()) {
                        ...
                        if (active) {
                            ...
                            final ObjectNode memberBody = ThreadLocalMapper.get().createObjectNode().put("active", true)
     ...
     * @throws Exception the exception
     */
    public static List<String> callAddMemberSingle(final String refsetId, final String url, final String conceptId, final String moduleId) throws Exception {

        final List<String> unaddedConcepts = new ArrayList<>();
        final ObjectNode body =
            ThreadLocalMapper.get().createObjectNode().put("refsetId", refsetId).put("moduleId", moduleId).put("referencedComponentId", conceptId);
     ...
     * @throws Exception the exception
     */
    public static List<String> callAddMembersBulk(final String refsetId, final String url, final List<String> conceptIds, final String moduleId)
        throws Exception {
    ...
    public static List<String> removeRefsetMembers(final TerminologyService service, final User user, final Refset refset, final String conceptIds)
        ...
        final String memberSearchUrlBase = SnowstormConnection.getRestBaseUrl() + branchPath + "/members?referenceSet=" + refset.getRefsetId()
            + "&offset=0&active=true" + "&limit=" + RefsetMemberService.URL_MAX_CHAR_LENGTH + "&" + SnowstormApiPaging.getMemberSortQueryString()
        ...
        while (searchAgain) {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                // array
                    ...
                    final ObjectNode memberBody = ThreadLocalMapper.get().createObjectNode().put("active", false)
                        .put("effectiveTime", conceptNode.get("effectiveTime").asText()).put("memberId", membershipId)
     ...
     * @throws Exception the exception
     */
    public static List<String> callUpdateMemberSingle(final String refsetId, final String url, final JsonNode memberBody) throws Exception {
     ...
     * @throws Exception the exception
     */
    public static List<String> callUpdateMembersBulk(final String refsetId, final String url, final ArrayNode memberBodies) throws Exception {
    ...
    public static int getMemberCount(final Refset refset) throws Exception {
        ...
        final String url = SnowstormConnection.getRestBaseUrl() + RefsetMemberService.getBranchPath(refset) + "/members?referenceSet=" + refset.getRefsetId()
            + "&active=true&offset=0&limit=1&" + SnowstormApiPaging.getMemberSortQueryString();
    ...
    public static String getMemberSctIds(final String refsetId, final int limit, final String searchAfter, final String branchPath) throws Exception {
        ...
        final String pagingParams = "&limit=" + limit + "&searchAfter=" + searchAfter + "&" + SnowstormApiPaging.getMemberSortQueryString();
