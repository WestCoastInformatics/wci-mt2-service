...
public class Edition extends AbstractHasModified {
  ...
  /**
   * The modules and names for this edition. TODO - This is a temporary field
   * until we fix sync to add the module name to the main modules field
   */
  @Transient
   ...
   */
  @FullTextField(analyzer = "standard")
  @GenericField(name = "namespaceSort", searchable = Searchable.YES, projectable = Projectable.NO,
      sortable = Sortable.YES)
   ...
   */
  @FullTextField(analyzer = "standard")
  @GenericField(name = "branchSort", searchable = Searchable.YES, projectable = Projectable.NO,
      sortable = Sortable.YES)
  ...
  public List<Map<String, String>> getFullyQualifiedLanguageRefsets() {
    ...
    for (final String languageRefsetCode : getDefaultLanguageRefsets()) {
      ...
      languageDetails.put("qualifiedLanguageDialectCode",
          LanguageConstants.LANGUAGE_CODE_TO_COUNTRY_CODE.get(languageRefsetCode) + "-"
      ...
      if (languageCode.equalsIgnoreCase(defaultLanguageCode)
        ...
        if (languageCode.equals("en")) {
          ...
          qualifiedLanguageList.add(1,
              Map.of("languageRefset", languageRefsetCode, "languageCode", languageCode,
                  "qualifiedLanguageRefset", languageRefsetCode + "FSN", "qualifiedLanguageCode",
                  languageCode.toUpperCase() + " (FSN)", "qualifiedLanguageDialectCode",
                  LanguageConstants.LANGUAGE_CODE_TO_COUNTRY_CODE.get(languageRefsetCode) + "-"
                      + languageCode.toUpperCase()));
        }
   ...
   */
  public void setFullyQualifiedLanguageRefsets(
    final List<Map<String, String>> qualifiedLanguageList) {
  ...
  public int hashCode() {
    ...
    result =
        prime * result + ((defaultLanguageRefsets == null) ? 0 : defaultLanguageRefsets.hashCode());
