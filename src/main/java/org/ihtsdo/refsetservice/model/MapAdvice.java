...
public class MapAdvice extends AbstractHasId {
     ...
     */
    public MapAdvice(final String id, final String name, final String detail, final boolean isAllowableForNullTarget, final boolean isComputed) {
    ...
    public String toString() {
        ...
        return "MapAdviceJpa [id=" + super.getId() + ", name=" + name + ", detail=" + detail + ", isAllowableForNullTarget=" + isAllowableForNullTarget
