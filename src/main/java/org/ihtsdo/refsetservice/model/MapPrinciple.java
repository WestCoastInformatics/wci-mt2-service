...
public class MapPrinciple extends AbstractHasId {
   ...
   */
  public MapPrinciple(final Long id, final String principleId, final String name,
      final String detail, final String sectionRef) {
  ...
  public String toString() {
    ...
    return "MapPrinciple [id=" + super.getId() + ", name=" + name + ", detail=" + detail
