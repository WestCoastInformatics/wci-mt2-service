...
@Indexed
public class MapProject extends AbstractHasModified
    implements Copyable<MapProject>, ValidateCrud<MapProject> {
   ...
   */
  public MapProject(final MapProject project) {
    super();
   ...
   *
   * @param destinationTerminologyVersion the new destination terminology
   *          version
   */
   ...
   *
   * @param mapPrincipleSourceDocumentName the new map principle source document
   *          name
   */
   ...
   */
  public void setAdditionalMapEntryInfos(
  ...
  public int hashCode() {
    ...
    result = prime * result + Objects.hash(additionalMapEntryInfos, description,
        destinationTerminology, destinationTerminologyVersion, editingCycleBeginDate, edition,
        errorMessages, groupStructure, latestPublicationDate, mapAdvices, mapLeads, mapNotesPublic,
        mapPrincipleSourceDocument, mapPrincipleSourceDocumentName, mapPrinciples, mapRefsetPattern,
        mapRelationStyle, mapRelations, mapReportDefinitions, mapSpecialists, moduleId, name,
        presetAgeRanges, primaryContactEmail, privateProject, propagatedFlag,
        propagationDescendantThreshold, published, refSetId, refSetName, reverseMapPattern,
        ruleBased, scopeConcepts, scopeDescendantsFlag, scopeExcludedConcepts,
        scopeExcludedDescendantsFlag, sourceTerminology, sourceTerminologyVersion, teamBased,
        useTags, workflowType);
    return result;
  }
  ...
  public boolean equals(final Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    final MapProject other = (MapProject) obj;
    return Objects.equals(additionalMapEntryInfos, other.additionalMapEntryInfos)
        ...
        && Objects.equals(editingCycleBeginDate, other.editingCycleBeginDate)
        && Objects.equals(edition, other.edition)
        && Objects.equals(errorMessages, other.errorMessages)
        && groupStructure == other.groupStructure
        && Objects.equals(latestPublicationDate, other.latestPublicationDate)
        && Objects.equals(mapAdvices, other.mapAdvices) && Objects.equals(mapLeads, other.mapLeads)
        && mapNotesPublic == other.mapNotesPublic
        && Objects.equals(mapPrincipleSourceDocument, other.mapPrincipleSourceDocument)
        && Objects.equals(mapPrincipleSourceDocumentName, other.mapPrincipleSourceDocumentName)
        && Objects.equals(mapPrinciples, other.mapPrinciples)
        && mapRefsetPattern == other.mapRefsetPattern && mapRelationStyle == other.mapRelationStyle
        && Objects.equals(mapRelations, other.mapRelations)
        && Objects.equals(mapReportDefinitions, other.mapReportDefinitions)
        && Objects.equals(mapSpecialists, other.mapSpecialists)
        && Objects.equals(moduleId, other.moduleId) && Objects.equals(name, other.name)
        && Objects.equals(presetAgeRanges, other.presetAgeRanges)
        && Objects.equals(primaryContactEmail, other.primaryContactEmail)
        && privateProject == other.privateProject && propagatedFlag == other.propagatedFlag
        && Objects.equals(propagationDescendantThreshold, other.propagationDescendantThreshold)
        && published == other.published && Objects.equals(refSetId, other.refSetId)
        && Objects.equals(refSetName, other.refSetName)
        && Objects.equals(reverseMapPattern, other.reverseMapPattern)
        && ruleBased == other.ruleBased && Objects.equals(scopeConcepts, other.scopeConcepts)
        && scopeDescendantsFlag == other.scopeDescendantsFlag
        && Objects.equals(scopeExcludedConcepts, other.scopeExcludedConcepts)
        && scopeExcludedDescendantsFlag == other.scopeExcludedDescendantsFlag
        ...
        && teamBased == other.teamBased && useTags == other.useTags
   ...
   */
  @Override
  public void populateFrom(final MapProject other) {
