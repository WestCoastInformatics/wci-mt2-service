...
public class DiscussionController extends BaseController {
    ...
    @ApiOperation(value = "Get discussions for the specified parameters. To see certain results this call requires authentication with the correct role.",
        response = ResultList.class)
    @ApiResponses(value = {
        @ApiResponse(code = 200, message = "Successfully retrieved the requested discussion"), @ApiResponse(code = 500, message = "Internal server error")
    })
    @ApiImplicitParams({
        @ApiImplicitParam(name = "type", value = "Object type, e.g. 'REFSET, REFSET_MEMEBER'", required = true, dataTypeClass = String.class,
            paramType = "path"),
        @ApiImplicitParam(name = "refsetInternalId", value = "The internal ID of the Refset", required = true, dataTypeClass = String.class,
            paramType = "path"),
        @ApiImplicitParam(name = "conceptId", value = "The concept ID of the refset member if this is a member type", required = false,
    ...
    public @ResponseBody ResponseEntity<ResultList<DiscussionThread>> getDiscussions(@PathVariable(value = "type") final DiscussionType type,
        ...
        try {
            ...
            LOG.debug("Get discussions for type: " + type.name() + "; refsetInternalId: " + refsetInternalId + "; conceptId: " + conceptId);
            ...
            try (final TerminologyService service = new TerminologyService()) {
                ...
                LOG.debug("getDiscussionThreads: results: " + ModelUtility.toJson(results));
    ...
    @ApiOperation(value = "Returns discussion thread. To see certain results this call requires authentication with the correct role.",
        response = DiscussionThread.class)
    @ApiResponses(value = {
        @ApiResponse(code = 200, message = "Successfully retrieved the requested discussion"), @ApiResponse(code = 500, message = "Internal server error")
    })
    @ApiImplicitParams({
    ...
    public @ResponseBody ResponseEntity<DiscussionThread> getDiscussion(@PathVariable(value = "id") final String id) throws Exception {
        ...
        try {
            ...
            LOG.debug("getDiscussion: Get discussion for id: " + id);
            ...
            try (final TerminologyService service = new TerminologyService()) {
                ...
                if (discussionThread == null) {
                    ...
                    LOG.info("getDiscussion: " + message);
    ...
    @ApiResponses(value = {
        @ApiResponse(code = 201, message = "Added discussion"), @ApiResponse(code = 401, message = "Unauthorized"),
    ...
    public @ResponseBody ResponseEntity<DiscussionThread> createDiscussionThread(@RequestBody final DiscussionThread thread) throws Exception {
        ...
        try {
            ...
            LOG.debug("createDiscussionThread thread: " + thread);
            ...
            try (final TerminologyService service = new TerminologyService()) {
                ...
                if ((refset.isPrivateRefset() || thread.isPrivateThread()) && !permittedRole) {
                    ...
                    LOG.error("createDiscussionThread: User does not have permissions to perform this action: {}.", user.getUserName());
                    throw new ResponseStatusException(HttpStatus.UNAUTHORIZED, "User does not have permissions to perform this action.");
                }
    ...
    @ApiResponses(value = {
        @ApiResponse(code = 201, message = "Added discussion post to discussion thread."), @ApiResponse(code = 401, message = "Unauthorized"),
        @ApiResponse(code = 404, message = "Not found"), @ApiResponse(code = 500, message = "Server error")
    })
    @ApiImplicitParams({
        @ApiImplicitParam(name = "threadId", value = "discussion thread id, e.g. &lt;uuid&gt;", required = true, dataTypeClass = String.class,
            paramType = "path"),
        @ApiImplicitParam(name = "post", value = "Post object.", required = true, dataTypeClass = DiscussionPost.class, paramType = "body"),
    })
    @RecordMetric
    public @ResponseBody ResponseEntity<DiscussionPost> createPost(@PathVariable(value = "threadId") final String threadId,
        @RequestBody final DiscussionPost post) throws Exception {

        try {

            LOG.debug("createPost threadId: " + threadId + "; post: " + post);
            final User user = SecurityService.getUserFromSession();
            ...
            try (final TerminologyService service = new TerminologyService()) {
                ...
                if (thread == null) {
                    ...
                    throw new ResponseStatusException(HttpStatus.NOT_FOUND, "Unable to find discussion thread for " + threadId + ".");
                }
                ...
                if ((refset.isPrivateRefset() || thread.isPrivateThread()) && !permittedRole) {
                    ...
                    LOG.error("createPost: User does not have permissions to perform this action: {}.", user.getUserName());
                    throw new ResponseStatusException(HttpStatus.UNAUTHORIZED, "User does not have permissions to perform this action.");
                }
            ...
            LOG.error("Error adding post: {} to discussionThreadId: {}", post, threadId);
            return handleException(e);
        }
    }
    ...
    @ApiResponses(value = {
        @ApiResponse(code = 200, message = "Updated discussion thread"), @ApiResponse(code = 401, message = "Unauthorized"),
        @ApiResponse(code = 404, message = "Not found"), @ApiResponse(code = 500, message = "Server error")
    })
    @ApiImplicitParams({
        @ApiImplicitParam(name = "threadId", value = "Discussion thread id, e.g. &lt;uuid&gt;", required = true, dataTypeClass = String.class,
    ...
    @RecordMetric
    public @ResponseBody ResponseEntity<DiscussionThread> updateDiscussionThread(@PathVariable(value = "threadId") final String threadId,
        @RequestBody final DiscussionThread thread) throws Exception {

        try {

            LOG.debug("updateDiscussionThread threadId: " + threadId + "; thread: " + thread);
            final User user = SecurityService.getUserFromSession();
            ...
            try (final TerminologyService service = new TerminologyService()) {
                ...
                if (!DiscussionService.canUserEditThread(user, refset, originalThread)) {
                    ...
                    LOG.error("updateDiscussionThread: User does not have permissions to perform this action: {}.", user.getUserName());
                    throw new ResponseStatusException(HttpStatus.UNAUTHORIZED, "User does not have permissions to perform this action.");
                }
            ...
            LOG.error("updateDiscussionThread Error updating thread for discussionThread: {}", thread.toString());
            return handleException(e);
        }
    }
    ...
    @ApiResponses(value = {
        @ApiResponse(code = 200, message = "Updated discussion thread status"), @ApiResponse(code = 401, message = "Unauthorized"),
        @ApiResponse(code = 404, message = "Not found"), @ApiResponse(code = 500, message = "Server error")
    })
    @ApiImplicitParams({
        @ApiImplicitParam(name = "threadId", value = "Discussion thread id, e.g. &lt;uuid&gt;", required = true, dataTypeClass = String.class,
    ...
    @RecordMetric
    public @ResponseBody ResponseEntity<DiscussionThread> updateDiscussionThreadStatus(@PathVariable(value = "threadId") final String threadId,
        @RequestParam final String status) throws Exception {

        try {

            LOG.debug("updateDiscussionThreadStatus threadId: " + threadId + "; status: " + status);
            ...
            try (final TerminologyService service = new TerminologyService()) {
                ...
                if (!DiscussionService.canUserEditThread(user, refset, thread)) {
                    ...
                    LOG.error("updateDiscussionThreadStatus: User does not have permissions to perform this action: {}.", user.getUserName());
                    throw new ResponseStatusException(HttpStatus.UNAUTHORIZED, "User does not have permissions to perform this action.");
                }
            ...
            LOG.error("updateDiscussionThreadStatus Error updating thread for discussionThread: {}", threadId);
            return handleException(e);
        }
    }
    ...
    @ApiResponses(value = {
        @ApiResponse(code = 200, message = "Successfully updated discussion thread privacy"), @ApiResponse(code = 401, message = "Unauthorized"),
        @ApiResponse(code = 404, message = "Not found"), @ApiResponse(code = 500, message = "Server error")
    })
    @ApiImplicitParams({
        @ApiImplicitParam(name = "threadId", value = "Discussion thread id, e.g. &lt;uuid&gt;", required = true, dataTypeClass = String.class,
    ...
    @RecordMetric
    public @ResponseBody ResponseEntity<DiscussionThread> updateDiscussionThreadPrivacy(@PathVariable(value = "threadId") final String threadId,
        @RequestParam final boolean isPrivate) throws Exception {

        try {

            LOG.debug("updateDiscussionThreadPrivacy threadId: " + threadId + "; isPrivate: " + isPrivate);
            ...
            try (final TerminologyService service = new TerminologyService()) {
                ...
                if (!DiscussionService.canUserEditThread(user, refset, thread)) {
                    ...
                    LOG.error("updateDiscussionThreadPrivacy: User does not have permissions to perform this action: {}.", user.getUserName());
                    throw new ResponseStatusException(HttpStatus.UNAUTHORIZED, "User does not have permissions to perform this action.");
                }
            ...
            LOG.error("updateDiscussionThreadPrivacy Error updating thread for discussionThread: {}", threadId);
            return handleException(e);
        }
    }
    ...
    @ApiResponses(value = {
        @ApiResponse(code = 200, message = "Updated discussion thread visibility"), @ApiResponse(code = 401, message = "Unauthorized"),
        @ApiResponse(code = 404, message = "Not found"), @ApiResponse(code = 500, message = "Server error")
    })
    @ApiImplicitParams({
        @ApiImplicitParam(name = "threadId", value = "Discussion thread id, e.g. &lt;uuid&gt;", required = true, dataTypeClass = String.class,
    ...
    @RecordMetric
    public @ResponseBody ResponseEntity<DiscussionThread> updateDiscussionThreadVisibility(@PathVariable(value = "threadId") final String threadId,
        @RequestParam final String visibility) throws Exception {

        try {

            LOG.debug("updateDiscussionThreadVisibility threadId: " + threadId + "; visibility: " + visibility);
            ...
            try (final TerminologyService service = new TerminologyService()) {
                ...
                if (!DiscussionService.canUserEditThread(user, refset, thread)) {
                    ...
                    LOG.error("updateDiscussionThreadVisibility: User does not have permissions to perform this action: {}.", user.getUserName());
                    throw new ResponseStatusException(HttpStatus.UNAUTHORIZED, "User does not have permissions to perform this action.");
                }
            ...
            LOG.error("updateDiscussionThreadVisibility Error updating thread for discussionThread: {}", threadId);
            return handleException(e);
        }
    }
    ...
    @ApiResponses(value = {
        @ApiResponse(code = 200, message = "Updated the discussion post privacy"), @ApiResponse(code = 401, message = "Unauthorized"),
        @ApiResponse(code = 404, message = "Not found"), @ApiResponse(code = 500, message = "Server error")
    })
    @ApiImplicitParams({
        @ApiImplicitParam(name = "threadId", value = "Discussion thread id, e.g. &lt;uuid&gt;", required = true, dataTypeClass = String.class,
    ...
    @RecordMetric
    public @ResponseBody ResponseEntity<DiscussionThread> updateDiscussionPostPrivacy(@PathVariable(value = "threadId") final String threadId,
        @PathVariable(value = "postId") final String postId, @RequestParam final boolean isPrivate) throws Exception {

        try {

            LOG.debug("updateDiscussionPostPrivacy threadId: " + threadId + "; postId: " + postId + "; isPrivate: " + isPrivate);
            ...
            try (final TerminologyService service = new TerminologyService()) {
                ...
                if (post == null) {
                    ...
                    throw new ResponseStatusException(HttpStatus.NOT_FOUND, "Unable to find discussion post for " + postId + ".");
                }

                // If the user does not have the correct permissions then return an error
                if (!DiscussionService.canUserEditPost(user, refset, post)) {

                    LOG.error("updateDiscussionPostPrivacy: User does not have permissions to perform this action: {}.", user.getUserName());
                    throw new ResponseStatusException(HttpStatus.UNAUTHORIZED, "User does not have permissions to perform this action.");
                }
            ...
            LOG.error("updateDiscussionPostPrivacy: Error updating thread for discussionThread: {}", threadId);
            return handleException(e);
        }
    }
    ...
    @ApiResponses(value = {
        @ApiResponse(code = 200, message = "Successfully updated the discussion post."), @ApiResponse(code = 401, message = "Unauthorized"),
    ...
    @RecordMetric
    public @ResponseBody ResponseEntity<DiscussionPost> updateDiscussionPost(@PathVariable(value = "threadId") final String threadId,
        @PathVariable(value = "postId") final String postId, @RequestBody final DiscussionPost updatedPost) throws Exception {

        try {

            LOG.debug("updateDiscussionPost threadId: " + threadId + "; postId: " + postId + "; post: " + updatedPost);
            ...
            try (final TerminologyService service = new TerminologyService()) {
                ...
                if (!postId.equals(updatedPost.getId())) {
                    ...
                    final String message =
                        "The postId parameter " + postId + " does not match the id property of the updatedPost parameter " + updatedPost.getId() + ".";
                ...
                if (!DiscussionService.canUserEditPost(user, refset, existingPost)) {
                    ...
                    LOG.error("updateDiscussionPost: User does not have permissions to perform this action: {}.", user.getUserName());
                    throw new ResponseStatusException(HttpStatus.UNAUTHORIZED, "User does not have permissions to perform this action.");
                }
            ...
            LOG.error("Error updating discussion post: {}; for thread: {}", postId, threadId);
            return handleException(e);
        }
    }
    ...
    @ApiResponses(value = {
        @ApiResponse(code = 200, message = "Successfully deleted discussion thread."), @ApiResponse(code = 401, message = "Unauthorized"),
        @ApiResponse(code = 404, message = "Not found"), @ApiResponse(code = 500, message = "Server error")
    })
    @ApiImplicitParams({
        @ApiImplicitParam(name = "threadId", value = "Discussion thread id, e.g. &lt;uuid&gt;", required = true, dataTypeClass = String.class,
    ...
    @RecordMetric
    public @ResponseBody ResponseEntity<DiscussionThread> deleteDiscussionPost(@PathVariable(value = "threadId") final String threadId,
        @PathVariable(value = "postId") final String postId) throws Exception {

        try (final TerminologyService service = new TerminologyService()) {

            LOG.debug("deleteDiscussionPost threadId: " + threadId + "; postId: " + postId);
            ...
            LOG.error("Error deleting discussion post: {}; for thread: {}", postId, threadId);
            return handleException(e);
        }
    }
    ...
    @ApiResponses(value = {
        @ApiResponse(code = 200, message = "Successfully deleted the provided discussion thread."), @ApiResponse(code = 401, message = "Unauthorized"),
        @ApiResponse(code = 404, message = "Not found"), @ApiResponse(code = 500, message = "Server error")
    })
    @ApiImplicitParams({
        @ApiImplicitParam(name = "threadId", value = "Discussion thread id, e.g. &lt;uuid&gt;", required = true, dataTypeClass = String.class,
    ...
    public @ResponseBody ResponseEntity<String> deleteDiscussionThread(@PathVariable(value = "threadId") final String threadId) throws Exception {
        ...
        try (final TerminologyService service = new TerminologyService()) {
            ...
            LOG.debug("deleteDiscussionThread threadId: " + threadId);
            ...
            LOG.error("deleteDiscussionThread Error deleting thread for discussionThread: {}", threadId);
            return handleException(e);
        }
    }
