...
public class MapSetController extends BaseController {
   ...
   * @param branch               The branch (e.g., MAIN/SNOMEDCT-NO/2024-04-15/WCITEST).
   * @param MapsetId             The RF2 MapsetId (e.g., "447562003" for the ICD10NO map).
   * @param refsetInternalId     The internal refset ID.
   * @param format               The export format (e.g., rf2, rf2_with_names, sctids).
  ...
  public @ResponseBody ResponseEntity<String> exportMapset(
      ...
      LOG.info("Exporting RF2 Mapset: MapsetId={}, Branch={}, Format={}, ExportType={}, FileNameDate={}, StartEffectiveTime={}, TransientEffectiveTime={}, ExportMetadata={}",
    		  mapsetId, branch, format, exportType, fileNameDate, startEffectiveTime, transientEffectiveTime, exportMetadata);
          ...
          if ("rf2".equalsIgnoreCase(format) || "rf2_with_names".equalsIgnoreCase(format)) {
              ...
              if ("SNAPSHOT".equalsIgnoreCase(exportType)) {
                  ...
                  LOG.info("Export completed successfully. Download URI: {}", downloadUri);
					  ...
					  downloadUri = MapSetService.exportMapsetRf2Delta( service, 
						  mapsetId, exportType, languageId, fileNameDate, startEffectiveTime,
						  transientEffectiveTime, exportMetadata, withNames ); 
					}        
          	} else if ("sctids".equalsIgnoreCase(format)) { 
          			downloadUri = MapSetService.exportMapsetSctidList(service, mapProject , branch, mapsetId, exportType, languageId, fileNameDate,
