...
public class RefsetController extends BaseController {
	...
	@Operation(summary = "Cache the ancestors of the refset members for the specified refset ID. To see certain results this call requires "
			+ "authentication with the correct role.", tags = { "refset" }, responses = {
	...
	@Operation(summary = "Download the specified refset export file", tags = { "refset" }, responses = {
			@ApiResponse(responseCode = "200", description = "Successfully retrieved the requested information"),
			@ApiResponse(responseCode = "400", description = "Bad request"),
			@ApiResponse(responseCode = "404", description = "Resource not found") })
	...
	@Operation(summary = "Get the concept for the specified ID", tags = { "refset" }, responses = {
			@ApiResponse(responseCode = "200", description = "Successfully retrieved the requested information"),
			@ApiResponse(responseCode = "400", description = "Bad request"),
			@ApiResponse(responseCode = "404", description = "Resource not found") })
	...
	@Operation(summary = "Gets a list of possible version statuses", tags = { "refset" }, responses = {
			@ApiResponse(responseCode = "200", description = "Successfully retrieved the requested information"),
			@ApiResponse(responseCode = "400", description = "Bad request"),
			@ApiResponse(responseCode = "404", description = "Resource not found") })
	@RecordMetric
	...
	@Operation(summary = "Gets a list of all current refset versions", tags = { "refset" }, responses = {
			@ApiResponse(responseCode = "200", description = "Successfully retrieved the requested information"),
			@ApiResponse(responseCode = "400", description = "Bad request"),
			@ApiResponse(responseCode = "404", description = "Resource not found") })
	@RecordMetric
	...
	@Operation(summary = "Gets a list of all the editions", tags = { "refset" }, responses = {
			@ApiResponse(responseCode = "200", description = "Successfully retrieved the requested information"),
			@ApiResponse(responseCode = "400", description = "Bad request"),
			@ApiResponse(responseCode = "404", description = "Resource not found") })
	@Parameters({
	...
	@Operation(summary = "Gets the list of branch versions", tags = { "refset" }, responses = {
			@ApiResponse(responseCode = "200", description = "Successfully retrieved the requested information"),
			@ApiResponse(responseCode = "400", description = "Bad request"),
			@ApiResponse(responseCode = "404", description = "Resource not found") })
	@Parameters({
	...
	@Operation(summary = "Gets a list of the organizations", tags = { "refset" }, responses = {
			@ApiResponse(responseCode = "200", description = "Successfully retrieved the requested information"),
			@ApiResponse(responseCode = "400", description = "Bad request"),
			@ApiResponse(responseCode = "404", description = "Resource not found") })
	@RecordMetric
	...
	@Operation(summary = "Request access to the refset for the specified ID", tags = { "refset" }, responses = {
			@ApiResponse(responseCode = "200", description = "Successfully retrieved the requested information"),
			@ApiResponse(responseCode = "404", description = "Resource not found") })
	@Parameters({
	...
	@Operation(summary = "Reset a refset to contain the contents of Snowstorm. Note only works if refset has not been upgraded during edit cycle. "
			+ "This call requires authentication with the correct role.", tags = { "refset" }, responses = {
