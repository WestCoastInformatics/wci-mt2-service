...
public class MapProjectService extends BaseService {
    ...
    public static MapProject getMapProject(final TerminologyService service, final String mapProjectId, final boolean includeMembers) throws Exception {
        ...
        mapProject.setSourceTerminologyVersion("2025-03-01");
        mapProject.setDestinationTerminology("ICD-10-CM");
        mapProject.setDestinationTerminologyVersion("2026");
        mapProject.setName("SNOMEDCT-US TO ICD-10-CM");
        ...
        edition.setShortName("SNOMEDCT-US");
        edition.setBranch("MAIN/SNOMEDCT-US/2025-03-01/WCITEST");
