...
public class RefsetMemberService {
    ...
    /**
     * A cache that lists each tree node concept whose children have been checked
     * for refset members.
     */
    ...
    public static List<Concept> getAllRefsetMembers(final String refsetInternalId, String searchAfter,
        ...
        try (final TerminologyService service = new TerminologyService()) {
            ...
            final String url = SnowstormConnection.BASE_URL + getBranchPath(refset) + "/concepts?ecl=%5E%20"
    ...
    private static List<String> identifyNonDefaultPreferredTerms(Edition edition) {
        ...
        if (edition.getDefaultLanguageCode() != null) {
            ...
            refsetToLanguagesMap.entrySet().stream().filter(entry -> languageToRemove.equals(entry.getValue()))
    ...
    private static List<Map<String, String>> sortConceptDescriptions(String conceptId,
            final Set<Map<String, String>> descriptions, Refset refset, List<String> nonDefaultPreferredTerms)
            throws Exception {
     ...
     * @throws Exception the exception
     */
    public static String searchDirectoryMembers(final SearchParameters searchParameters) throws Exception {
    ...
    public static String exportRefsetRf2(final String refsetInternalId, final String type, final String languageId,
        ...
        try (final TerminologyService service = new TerminologyService()) {
            ...
            if (!S3ConnectionWrapper.isInS3Cache(deltaAwsVersionedPath, deltaRt2VersionFileName)) {
                ...
                for (String versionInScope : versionsInScope) {
                    ...
                    String fileNamePath = localSnowGeneratedFilePath.replace(".zip", "") + File.separator
                    ...
                    if (withNames) {
                        ...
                        Refset specificRefset = service
                                .findSingle("id:" + versionToRefsetInternalId.get(versionInScope), Refset.class, null);
    ...
    private static void appendNamesToRf2(final Refset refset, final String origFilePath, String newFileWithNamesPath,
            final String languageId) throws Exception {
    ...
    private static String getMemberSctids(final String refsetId, final int offset, final int limit,
        ...
        String url = SnowstormConnection.BASE_URL + "browser/" + branchPath + "/members?referenceSet=" + refsetId + "&"
                + pagingParams;
     ...
     * @throws Exception the exception
     */
    public static String exportRefsetSctidList(final String refsetInternalId, final boolean exportMetadata)
            throws Exception {
        ...
        try (final TerminologyService service = new TerminologyService()) {
            ...
            while (morePages) {
                ...
                final String resultString = getMemberSctids(refset.getRefsetId(), offset, limit, getBranchPath(refset));
    ...
    public static String exportFreeset(final String refsetInternalId) throws Exception {
        ...
        try (final TerminologyService service = new TerminologyService()) {
            ...
            List<Concept> concepts = getAllRefsetMembers(refsetInternalId, "", new ArrayList<Concept>());
    ...
    /**
     * Get the cached set of tree nodes checked for members of the specified refset.
     *
...
//        }
     ...
     * @throws Exception the exception
     */
    public static Map<String, Concept> getCachedRefsetMembers(final String refsetInternalId) throws Exception {
    ...
    public static void populateAllLanguageDescriptions(final Refset refset, final List<Concept> conceptsToProcess)
        ...
        final String url = SnowstormConnection.BASE_URL + getBranchPath(refset) + "/descriptions?limit=3000";
     ...
     * @throws Exception             the exception
     */
    public static List<Concept> getConceptAncestors(final Refset refset, final List<Concept> concepts)
            throws MalformedURLException, Exception {
        ...
        try (final Response response = SnowstormConnection.getResponse(url)) {
            ...
            while (iterator.hasNext()) {
                ...
                final Concept concept = concepts.stream()
                        .filter(filterConcept -> nodeConceptId.equals(filterConcept.getCode())).findFirst()
                        .orElse(null);
        ...
        for (Map.Entry<String, List<Concept>> cachedPath : cachedPaths.entrySet()) {
            ...
            final Concept concept = concepts.stream()
                    .filter(filterConcept -> cachedPath.getKey().equals(filterConcept.getCode())).findFirst()
                    .orElse(null);
    ...
    public static ConceptResultList searchConcepts(final Refset refset,
        ...
        // Create Snowstorm URL
        String url = SnowstormConnection.BASE_URL + getBranchPath(refset)
...
//        }
    ...
    public static Concept getConceptDetails(String conceptId, Refset refset) throws Exception {
        ...
        if (conceptDetailsCache.containsKey(refsetInternalId + conceptId)) {
            ...
            logger.debug("Using cached concept details refsetInternalId: " + refsetInternalId + " ; conceptId: "
                    + conceptId);
            ...
            try {
                ...
                ConceptResultList conceptResultList = getConceptsFromSnowstorm(url, refset, lookupParameters);
                ...
                throw new Exception("Could not get refset children for concept " + conceptId + " from snowstorm: "
                        + ex.getMessage(), ex);
            }
        }
    }
    ...
    protected static ConceptResultList getChildren(final String conceptId, final Refset refset, final String language) throws Exception {
        ...
        try {
            ...
            final String branchPath = getBranchPath(refset);
            final String url = SnowstormConnection.BASE_URL + "browser/" + branchPath + "/" + "concepts/" + conceptId
            ...
            if (missingLookupParameters == null) {
                ...
                if (conceptNode.has("referencedComponentId")) {
                 ...
                 // Add FSN if required
                    ...
                    if (ancestorsCache.containsKey(refset.getId())
     ...
     * @throws Exception
     */
    private static List<Map<String, String>> populateDescriptions(String conceptId, JsonNode descriptions,
            Refset refset, List<String> nonDefaultPreferredTerms) throws Exception {
    ...
    private static void populateMembershipInformation(Refset refset, List<Concept> conceptsToProcess) throws Exception {
    ...
    public static List<Map<String, String>> getMemberHistory(String referencedComponentId,
        ...
        try (final TerminologyService service = new TerminologyService()) {
            ...
            for (Map<String, String> version : versions) {
                ...
                if ("beta, published, ind development".contains(version.get("status").toLowerCase())) {
                    ...
                    if (refset == null) {
                        throw new Exception(
                                "Refset Internal Id: " + refsetInternalId + " does not exist in the RT2 database");
                    }

                    final String url = SnowstormConnection.BASE_URL + getBranchPath(refset) + "/members?referenceSet="
                            + refset.getRefsetId() + "&referencedComponentId=" + referencedComponentId;
                    ...
                    try (final Response response = SnowstormConnection.getResponse(url)) {
                        ...
                        throw new Exception("Could not grab refset members for refset " + refset.getRefsetId()
                                + " from snowstorm: " + ex.getMessage(), ex);
                    }
                }
            }
    ...
    public static boolean cacheMemberAncestors(String refsetInternalId) throws Exception {
        ...
        try (final TerminologyService service = new TerminologyService()) {
            ...
            try {
                ...
                final String url = SnowstormConnection.BASE_URL + getBranchPath(refset) + "/concepts?ecl=%3E(%5E"
                        + refset.getRefsetId() + ")&limit=1000";
                ...
                throw new Exception("Could not cache the ancestors of refset " + refset.getRefsetId()
                        + " from snowstorm: " + ex.getMessage(), ex);
            }
        }
    }
     ...
     * @throws Exception the exception
     */
    public static List<String> addRefsetMembers(final String refsetInternalId, List<String> conceptIds)
            throws Exception {
            ...
            for (final String conceptId : conceptIds) {
                ...
                try (final Response response = SnowstormConnection.postResponse(url, body.toString())) {
                    ...
                    if (response.getStatus() != Response.Status.OK.getStatusCode()) {
                        ...
                        logger.error("Add Refset Member call to url '" + url + "' for refset '" + refsetId
                                + "' and concept '" + conceptId + "' wasn't successful. " + response.toString());
    ...
    public static List<String> removeRefsetMembers(final String refsetInternalId, String conceptIds) throws Exception {
        ...
        try (final TerminologyService service = new TerminologyService()) {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (!released) {
                    ...
                    try (final Response response = SnowstormConnection.deleteResponse(url)) {
                        ...
                        if (response.getStatus() != Response.Status.NO_CONTENT.getStatusCode()) {
                            ...
                            logger.error("Unable to delete refset member: " + conceptId + " ; membership ID: "
                                    + membershipId + ". Status: " + Integer.toString(response.getStatus()) + ". Error: "
                                    + response.toString());
                            couldNotRemove = true;
                        }
                ...
                // if the member has been released or it couldn't be removed then inactivate the
                // membership
                if (released || couldNotRemove) {
                    ...
                    try (final Response response = SnowstormConnection.putResponse(url, memberBody.toString())) {
                        ...
                        if (response.getStatus() != Response.Status.OK.getStatusCode()) {
                            ...
                            logger.error("Unable to inactivate refset member: " + conceptId + " ; membership ID: "
                                    + membershipId + ". Status: " + Integer.toString(response.getStatus()) + ". Error: "
                                    + response.toString());
            ...
            try (final Response response = SnowstormConnection.getResponse(url)) {
                ...
                if (response.getStatus() != Response.Status.OK.getStatusCode()) {
                    throw new Exception("Unable to get refset concepts. Status: "
                            + Integer.toString(response.getStatus()) + ". Error: " + response.toString());
                }
