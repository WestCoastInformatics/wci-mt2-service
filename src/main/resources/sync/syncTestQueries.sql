-- *** ONE QUERY PER LINE, FULL QUERY ON ONE LINE ***
-- use -- to comment out query or lines
-- *** All Refsets ***
...
select * from refsets_definition_clauses;
select * from refsets where type like 'IN%' and name like 'WCI%';
