...
/**
 * Unit test for {@link AuditEntry}.
 */
@SpringBootTest
@ActiveProfiles("test")
public class AuditEntryUnitTest extends BaseTest {
    ...
    public void testModelCopy() throws Exception {
        ...
        assertTrue(tester.testCopyConstructor(AuditEntry.class));
    }
