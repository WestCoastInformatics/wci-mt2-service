...
/**
 * Unit test for {@link WorkflowHistory}.
 */
@SpringBootTest
@ActiveProfiles("test")
public class WorkflowHistoryUnitTest extends BaseTest {

    private WorkflowHistory object;
    ...
    public void testModelCopy() throws Exception {
        ...
        assertTrue(tester.testCopyConstructor(WorkflowHistory.class));
    }
