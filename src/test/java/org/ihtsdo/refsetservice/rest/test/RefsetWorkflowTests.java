...
public class RefsetWorkflowTests extends AbstractRefsetTests {
    ...
    public void testOnExistingRefsetBranch() throws Exception {
        ...
        try (final TerminologyService service = new TerminologyService()) {
            ...
            success = WorkflowService.mergeEditIntoRefsetBranch(refset.getEdition().getBranch(), refsetId, refset.getEditBranchId(), refset.getRefsetBranchId(), "Merging after adding one member to refset", refset.isLocalSet());
            assertThat(success).isTrue();
