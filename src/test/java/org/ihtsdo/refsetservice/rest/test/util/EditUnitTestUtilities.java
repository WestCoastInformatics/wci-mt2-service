...
public class EditUnitTestUtilities {
    ...
    public String createNewRefsetVersion(final String refsetId) {
        ...
        try {
            ...
            final ObjectNode newVersionBody = ThreadLocalMapper.get().createObjectNode();
            // .put("readVersion","");
            ...
            final JsonNode newVersionRoot = ThreadLocalMapper.get().readTree(newVersionContent);
    ...
    public void modifyRefsetMetadata(final String refsetId, final Map<String, String> modifyData) {
        ...
        try {
            ...
            final ObjectNode modifyBody =
                ThreadLocalMapper.get().createObjectNode().put("narrative", modifyData.get("narrative")).put("versionNotes", modifyData.get("versionNotes"))
                    .set("tags", ThreadLocalMapper.get().createArrayNode().add(modifyData.get("tag1")).add(modifyData.get("tag2")));
            ...
            final JsonNode modifyRoot = ThreadLocalMapper.get().readTree(modifyContent);
    ...
    private Map<String, String> defineRefsetConcept(final Map<String, String> refsetNewConcept, final String testName, final RefsetType refsetType) {
        ...
        final ObjectNode refsetNewConceptBody =
            ThreadLocalMapper.get().createObjectNode().put("name", refsetNewConcept.get("name")).put("parentConceptId", refsetNewConcept.get("parentConceptId"))
        ...
        if (refsetNewConcept.containsKey("ecl")) {
            ...
            refsetNewConceptBody.set("definitionClauses", ThreadLocalMapper.get().createArrayNode()
                .add(ThreadLocalMapper.get().createObjectNode().put("value", refsetNewConcept.get("ecl")).put("negated", "false")));
        }
    ...
    public JsonNode populateRefset(final String refsetInternalId, final Map<String, String> refsetDetail) {
        ...
        try {
            ...
            final JsonNode membersRoot = ThreadLocalMapper.get().readTree(membersContent);
    ...
    public void validateRefsetContents(final String refsetInternalId, final int numConceptsAdded) {
        ...
        try {
            ...
            final JsonNode conceptRoot = ThreadLocalMapper.get().readTree(countContent);
    ...
    public void removeRefsetContent(final String refsetInternalId, final Map<String, String> refsetDetail, final JsonNode membersNode) {
        ...
        try {
            ...
            if (membersNode.has("status")) {
                ...
                final JsonNode removeRoot = ThreadLocalMapper.get().readTree(removeContent);
    ...
    public void deleteVersionedRefset(final String refsetId) {
        ...
        try {
            ...
            final JsonNode deleteRoot = ThreadLocalMapper.get().readTree(deleteContent);
    ...
    public ResultList<UpgradeInactiveConcept> getUpgradeData(final String refsetInternalId) {
        ...
        try {
            ...
            final ResultList<UpgradeInactiveConcept> resultList =
                ThreadLocalMapper.get().readValue(content, (new TypeReference<ResultList<UpgradeInactiveConcept>>() {
                    // n/a
                }));
    ...
    public ResultList<UpgradeReplacementConcept> searchReplacementConcepts(final String internalRefsetId, final String searchTerm) {
        ...
        try {
            ...
            final ResultList<UpgradeReplacementConcept> results =
                ThreadLocalMapper.get().readValue(content, (new TypeReference<ResultList<UpgradeReplacementConcept>>() {
                    // n/a
                }));
    ...
    public RefsetMemberComparison getComparisonData(final String activeRefsetInternalId) {
        ...
        try {
            ...
            final RefsetMemberComparison refsetMemberComparison = ThreadLocalMapper.get().readValue(content, RefsetMemberComparison.class);
