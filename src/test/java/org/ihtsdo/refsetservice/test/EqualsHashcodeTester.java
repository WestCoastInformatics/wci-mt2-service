...
public class EqualsHashcodeTester extends ProxyTester {
    ...
    /** The Constant LOG. */
    private static final Logger LOG = LoggerFactory.getLogger(EqualsHashcodeTester.class);
    ...
    public boolean testIdentityFieldEquals() throws Exception {
        ...
        if (o1.equals(o2)) {
            ...
            LOG.info("o2 = " + o2.hashCode() + ", " + o2);
            return false;
        }
    }

    /**
     * Creates two objects and verifies for each that changing the non-included or excluded fields makes no difference to equality testing.
     *
     * @return true, if successful
     * @throws Exception the exception
     */
    ...
    public boolean testIdentityFieldNotEquals() throws Exception {
        ...
        LOG.debug("Test identity field not equals - " + getClazz().getName());
    ...
    /**
     * Creates two objects and verifies for each that changing the non-included or excluded fields does not affect the hashcode.
     *
     * @return true, if successful
     * @throws Exception the exception
     */
    ...
    /**
     * Creates two objects and verifies that any difference in identity fields produces different hashcodes.
     *
     * @return true, if successful
     * @throws Exception the exception
     */
    public boolean testIdentityFieldDifferentHashcode() throws Exception {
        ...
        LOG.debug("Test identity field different hashcode - " + getClazz().getName());
