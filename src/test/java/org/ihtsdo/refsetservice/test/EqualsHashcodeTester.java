...
public class EqualsHashcodeTester extends ProxyTester {
    ...
    /**
     * Creates two objects with the same field values and verifies they are
     * equal.
     *
    ...
    /**
     * Creates two objects and verifies for each that changing the non-included
     * or excluded fields makes no difference to equality testing.
     *
     * @return true, if successful
     * @throws Exception the exception
     */
    ...
    /**
     * Creates two objects with the same field values and verifies they have
     * equal hashcodes.
     *
     * @return true, if successful
     * @throws Exception the exception
    ...
    /**
     * Creates two objects and verifies for each that changing the non-included
     * or excluded fields does not affect the hashcode.
     *
     * @return true, if successful
     * @throws Exception the exception
     */
